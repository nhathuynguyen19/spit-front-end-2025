...
function CardMonAn({ src, title, des }: CardMonAnProps) {
  return (
    <div className="image-card h-full m-4 aspect-[1/1.5] transition-transform duration-300 ease-in-out cursor-pointer md:h-[calc(100%/1.5)] md:h-[100%]">
      ...
      <p className="text-gray-700 text-[10px] sm:text-sm cursor-text italic">{des}</p>
    </div>
  );
}
